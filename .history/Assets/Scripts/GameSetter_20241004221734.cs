...
public class GameSetter : MonoBehaviour
{
    ...
    void Start()
    {
        randomWord = "Yagmur";  // Example word, adjust as needed

        int gridSize = randomWord.Length;  // Grid size will be based on word length (NxN grid)
        ...
        Vector3 gridStartPos = new Vector3(
            originalPos.position.x - totalGridWidth / 2f,  // Center the grid horizontally
