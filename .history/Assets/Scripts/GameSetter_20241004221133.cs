...
public class GameSetter : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i=0; i < randomWord.Length; i++){
            GameObject letterObjectC = Instantiate(LetterObjectPrefab, canvas.transform);
            letterObject.transform.position = new Vector3(originalPos.position.x + letterXOffset, originalPos.position.y,
