                        ...
                        foreach (Transform c in parentTransform)
                        {
                            if (c.tag == "Letter")
                            {
                                if (c.GetComponent<Letter>().point.x == i)
                                {
                                    ...
                                    if (givenLetter != '\0')
                                    {
                                        bool isCorrectPosition = ContainsAndCorrectSpot(randomWord, givenLetter, c.GetComponent<Letter>().point.y);
                                        ...
                                        {
                                            c.GetComponent<Letter>().SetColor(Color.red); // Letter is in the word but in the wrong position
                                        }
