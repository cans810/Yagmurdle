                            ...
                            if (c.tag == "Letter")
                            {
                                ...
                                if (letterComponent.point.x == i)
                                {
                                    ...
                                    if (givenLetter != '\0')
                                    {
                                        ...
                                        if (ContainsAndCorrectSpot(randomWord, givenLetter, letterComponent.point.x))
                                        {
                                        ...
                                        else if (ContainsAndCorrectSpot(randomWord, givenLetter, letterComponent.point.x) == false)
                                        {
