...
public class GameSetter : MonoBehaviour
{
    ...
    void GenerateGame()
    {
        ...
        // Set letter offset based on screen width and grid size
        letterXOffset = screenWidth / gridSize;
        letterYOffset = letterXOffset; // Make it square for simplicity
        ...
        Vector3 gridStartPos = new Vector3(
            ...
            originalPos.position.y + totalGridHeight / 2f, // Adjust for Y position
