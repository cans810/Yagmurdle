        ...
        if (gameGenerated){
            ...
            foreach (Transform child in parentTransform)
            {
                if (child.tag == "Letter"){
                    ...
                    if (child.GetComponent<Letter>().currentlyActive && (child.GetComponent<Letter>().inputField.text != "" || child.GetComponent<Letter>().inputField.text != null)){
                        ...
                        {
                            if (child1.tag == "Letter" && child1.GetComponent<Letter>().point == curr){
