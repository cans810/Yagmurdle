...
else
{
    ...
    givenAnswers[i] = answer; // Or handle it as needed
}
                        ...
                        foreach(Transform c in parentTransform){
                            if (c.tag == "Letter"){
                                if (c.GetComponent<Letter>().point.x == i){
                                    if (ContainsAndCorrectSpot(randomWord, c.GetComponent<Letter>().inputField.text)){
                                        c.GetComponent<Letter>().SetColor(Color.green);
                                    }
                                    else if (!ContainsAndCorrectSpot(randomWord, c.GetComponent<Letter>().inputField.text)){
